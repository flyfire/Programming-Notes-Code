...
import com.ztiany.progress.manager.RequestProgressInterceptor;
...
public class ConfigGlideModule extends AppGlideModule {
    ...
    public void registerComponents(Context context, Glide glide, Registry registry) {
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                .addInterceptor(new RequestProgressInterceptor());

        OkHttpClient.Builder builder = progressManager.withProgress(okHttpClient.newBuilder());
