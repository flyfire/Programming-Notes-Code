...
abstract class ProgressResponseBody extends ResponseBody {
        ...
        return new ForwardingSource(source) {
            ...
            public long read(@NonNull Buffer sink, long byteCount) throws IOException {
                ...
                if (curTime - lastRefreshTime >= mRefreshTime || bytesRead == -1 || totalBytesRead == mContentLength) {
                    ...
                    onProgress(mContentLength, totalBytesRead, totalBytesRead * 1.0F / mContentLength, finish);
    ...
    abstract void onProgress(long contentLength, long currentBytes, float percent, boolean isFinish);
