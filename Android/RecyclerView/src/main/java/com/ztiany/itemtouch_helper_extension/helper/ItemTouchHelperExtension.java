package com.ztiany.itemtouch_helper_extension.helper;
...
public class ItemTouchHelperExtension extends RecyclerView.ItemDecoration
    ...
    private static final int ACTIVE_POINTER_ID_NONE = -1;//收拾id

    private static final int DIRECTION_FLAG_COUNT = 8;//方向表示位数量

    private static final int ACTION_MODE_IDLE_MASK = (1 << DIRECTION_FLAG_COUNT) - 1;//位遮罩
     ...
     */
    private static final int PIXELS_PER_SECOND = 1000;//计算速度单位
