package com.ztiany.item_decoraion_index;
...
import com.ztiany.UnitConverter;
...
public class StickySectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickySectionDecoration(Context context, GroupInfoCallback callback) {
        ...
        mDividerHeight = (int) UnitConverter.dpToPx(1.5F);
        mHeaderHeight = UnitConverter.dpToPx(20);
        mTextSize = UnitConverter.spToPx(12);
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int index = parent.getChildAdapterPosition(view);//列表索引位置
            ...
            if (mCallback != null) {
                ...
                if (i != 0) {
                    ...
                    int top = parent.getPaddingTop();//此时的高度始终式parent的paddingTop
