...
/*
 function的隐式arguments参数是一个类数组
 DOM中getElementsByTagName()返回的是一个类数组
 */
...
//js数组的方法是特意定义为通用的，因此它们可以用在类数组对象上，ES5中所有的数组方法都是通用的，ES3中出toString和toLocalString方法都是通用的。
//使用方式为Function.call
